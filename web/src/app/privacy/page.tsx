    ...
    <main className="min-h-screen">
      <div className="container py-16 md:py-24 prose-container">
        ...
        <div className="space-y-16">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-6 text-white">2. Data Storage</h2>
            <p className="text-body">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-6 text-white">6. Changes to This Policy</h2>
            <p className="text-body">
          ...
          <section>
            <h2 className="text-2xl font-bold mb-6 text-white">7. Contact Us</h2>
            <p className="text-body">
